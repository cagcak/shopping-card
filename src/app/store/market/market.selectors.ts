...
export const selectShop = createSelector(selectMarketFeature, (state) => state?.shop);
export const selectBasket = createSelector(selectMarketFeature, (state) => state?.basket);
